...
<head>
	...
	<!-- UNIFORM -->
	<link rel="stylesheet" type="text/css" href="asset/js/uniform/css/uniform.default.min.css" />
	<!-- ANIMATE -->
	<link rel="stylesheet" type="text/css" href="asset/css/animatecss/animate.min.css" />
	<!-- FONTS -->
...
<body class="login">	
							...
							<div class="login-box-plain">
								...
								<form role="form">
								  <div class="form-group">
									<label for="exampleInputEmail1">Username/NIK</label>
	...
	<!-- UNIFORM -->
	<script type="text/javascript" src="asset/js/uniform/jquery.uniform.min.js"></script>
	<!-- CUSTOM SCRIPT -->
